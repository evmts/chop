	...
	it.effect("non-JSON path: handler returns name logged directly", () =>
		Effect.gen(function* () {
			...
			const resolverCode = new Uint8Array([
				...
				0x60, 0x68, 0x60, 0x28, 0x52, // 'h' at mem[71]
				0x60, 0x74, 0x60, 0x27, 0x52, // 't' at mem[70]
				0x60, 0x65, 0x60, 0x26, 0x52, // 'e' at mem[69]
				0x60, 0x2e, 0x60, 0x25, 0x52, // '.' at mem[68]
				0x60, 0x74, 0x60, 0x24, 0x52, // 't' at mem[67]
				0x60, 0x73, 0x60, 0x23, 0x52, // 's' at mem[66]
				0x60, 0x65, 0x60, 0x22, 0x52, // 'e' at mem[65]
				0x60, 0x74, 0x60, 0x21, 0x52, // 't' at mem[64]
				// length=8
